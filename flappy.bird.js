...
//Require carrot
const {Neat , Network } = require("@liquid-carrot/carrot")

//New Network using Carrot
...
//Basic game funtions like loading images and FPS
...
//How bird will function (Nothing involving neuro)
...
// How pipes will function in game (Nothing involving neuro)
...
//How game works and neuro evolves
var Game = function(){
	this.pipes = [];
	this.birds = [];
	this.score = 0;
...
Game.prototype.start = function(){
	...
	this.birds = [];
	this.network;
	this.gen = Neuvol.createPopulation();
...
Game.prototype.isItEnd = function(){ //None
	for(var i in this.birds){
		if(this.birds[i].alive){
			return false;
		}
...
Game.prototype.display = function(){ //None
